...
def annotate_screenshot(device: str, slug: str, report: dict):
    ...
    with open(warnings_path, "w", encoding="utf-8") as f:
        f.write(f"Non-Visual / SEO Status — Popup — {device} ({slug})\n")
        f.write("=" * 50 + "\n\n")
        ...
        if floating_messages:
            ...
            f.write("- All correct!\n")
    print("  Non-visual warnings saved.")
...
def generate_summary_report(all_reports: list, slug: str):
    ...
    with open(path, "w", encoding="utf-8") as f:
        f.write(f"POPUP BUTTON DIFF REPORT — {slug}\n")
        f.write("=" * 60 + "\n\n")
...
if __name__ == "__main__":
    ...
    report_path = os.path.join(REPORTS_DIR, f"popup-{args.slug}.json")
